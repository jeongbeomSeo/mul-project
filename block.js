...
const Block1 = nextBlock(["1000"]);
addBlock(Block1);

const Block2 = nextBlock(["1500"]);
addBlock(Block2);

const Block3 = nextBlock(["2000"]);
addBlock(Block3);
...
const block3Hash = createHash(Block3);
console.log("Genesis Block's Body: ", genesisBlock.body);
console.log("Genesis Block's Hash: ", genesisHash);
console.log("Block1's Body:        ", Block1.body);
console.log("Block1's Hash:        ", block1Hash);
console.log("Block2's Body:        ", Block2.body);
console.log("Block2's Hash:        ", block2Hash);
console.log("Block3's Body:        ", Block3.body);
console.log("Block3's Hash:        ", block3Hash);